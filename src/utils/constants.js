...
export const ABOUT = {
    ...
    P_3: 'This is an initial (unreleased) version, plenty more features to come. Next will be upload hooks with lambda, email notifications, user authenticated sections, and more! Please send an email to damanirohan@gmail.com for more information, or visit the link at the bottom.',
}
